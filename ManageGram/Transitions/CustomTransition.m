...
@implementation CustomTransition : NSObject

NSString * CustomTransitionAnimationKey = @"CustomTransitionAnimationKey";
NSString * CustomTransitionAnimationInValue = @"CustomTransitionAnimationInValue";
NSString * CustomTransitionAnimationOutValue = @"CustomTransitionAnimationOutValue";
