...
//  DownloadManager
//
//  Created by Yang Guo on 10/19/14.
//  Copyright (c) 2014 Kr.Mobile. All rights reserved.
//
...
{
    [[[UIAlertView alloc] initWithTitle:titl message:msg delegate:self cancelButtonTitle:@"Ok" otherButtonTitles:nil] show];
}
