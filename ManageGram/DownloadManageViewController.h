//
//  UIViewController+DownloadViewController.h
//  ManageGram
//
...
@interface DownloadManageViewController : UIViewController
{
 ...
 */
@property(nonatomic, weak) IBOutlet UITableView *downloadTableView;

@property(nonatomic, weak) IBOutlet UITableView *downloadedTableView;
